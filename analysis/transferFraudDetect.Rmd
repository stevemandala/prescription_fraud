...
med2011 <- gsub(pattern = " (\\(.*\\))", replacement = "", x= medicine2011$name)
## change all to upperCase
med2011 <- toupper(med2011)
index2011 <- which(unique(med2011) %in% partD$DRUG_NAME)
index2011
use2011 <- medicine2011[index2011,]
use2011$year <- rep(2011, length(use2011[,1]))

# 2012
med2012 <- gsub(pattern = " (\\(.*\\))", replacement = "", x= medicine2012$name)
## change all to upperCase
med2012 <- toupper(med2012)
index2012 <- which(unique(med2012) %in% partD$DRUG_NAME)
index2012
use2012 <- medicine2013[index2012,]
use2012$year <- rep(2012, length(use2012[,1]))

# 2013
med2013 <- gsub(pattern = " (\\(.*\\))", replacement = "", x= medicine2013$name)
## change all to upperCase
med2013 <- toupper(med2013)
index2013 <- which(unique(med2013) %in% partD$DRUG_NAME)
index2013
use2013 <- medicine2013[index2013,]
use2013$year <- rep(2013, length(use2013[,1]))
```
